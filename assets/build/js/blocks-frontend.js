...
jQuery(document).ready(function ($) {
  ...
  */
  ...
  function checkRequiredFields(searchElm) {
    ...
    const requiredInputs = searchElm.find('input[required], select[required], textarea[required]');
    ...
    requiredInputs.each(function () {
      ...
      if (tagName === 'input') {
        if (type === 'checkbox' || type === 'radio') {
          ...
          const checked = searchElm.find(`input[name="${name}"]:checked`).length > 0;
          if (!checked) {
  ...
  function buildFormData(searchElm) {
    ...
    const price_range = searchElm.find("input[name='price_range']:checked").val();
    ...
    const directory_type = searchElm.find('input[name="directory_type"]').val() || searchElm.closest('.directorist-instant-search').find('input[name="directory_type"]').val();
    ...
    // open_now checkbox
    const open_now_val = searchElm.find('input[name="open_now"]').is(':checked') ? searchElm.find('input[name="open_now"]').val() : undefined;
    updateFormData({
      open_now: open_now_val
    });
    const radius_search_based_on = searchElm.find('.directorist-radius_search_based_on').val();
  ...
  function singleCategoryLocationInit() {
    ...
    const {
      ...
      location,
      category
    } = JSON.parse(directoristDataAttributes);
  ...
  */
  ...
  $('body').on('keyup', '.directorist-instant-search form', (0,_utils_debounce__WEBPACK_IMPORTED_MODULE_0__["default"])(function (e) {
  ...
  $('body').on('change', '.directorist-instant-search .directorist-search-location, .directorist-instant-search .directorist-zipcode-search', (0,_utils_debounce__WEBPACK_IMPORTED_MODULE_0__["default"])(function (e) {
    e.preventDefault();
  ...
  $('body').on('change', '.directorist-instant-search select', (0,_utils_debounce__WEBPACK_IMPORTED_MODULE_0__["default"])(function (e) {
    e.preventDefault();
    if (!$(this).val()) {
      return; // Skip search if the value is empty
    }
    e.preventDefault();
    var searchElm = $(this).val() && $(this);
  ...
  $('body').on('click', '.directorist-instant-search .directorist-filter-location-icon', (0,_utils_debounce__WEBPACK_IMPORTED_MODULE_0__["default"])(function (e) {
    e.preventDefault();
    var searchElm = $(this);
  ...
  $('body').on('click', '.directorist-instant-search .directorist-btn-reset-js', function (e) {
    ...
    const debouncedResetSearch = (0,_utils_debounce__WEBPACK_IMPORTED_MODULE_0__["default"])(function () {
      // Build form data
      buildFormData(activeForm);
