...
export const handleRadiusVisibility = () => {
    ...
    document.querySelectorAll(selector).forEach(locationDOM => {
        ...
        const radiusFields = contentsWrap.querySelectorAll
            ? contentsWrap.querySelectorAll('.directorist-search-field-radius_search, .directorist-radius-search')
            : document.querySelectorAll('.directorist-search-field-radius_search, .directorist-radius-search');
