...
import previewImg from '@image/blocks-preview/fax.webp';
...
export default function Edit({ attributes, setAttributes }) {
	...
	return (
		<div
			className="directorist-gutenberg-listing-card-element directorist-gutenberg-listing-card-element-fax"
		>
			<div className="directorist-gutenberg-listing-card-element-content">
				...
				<div className="directorist-gutenberg-listing-card-element-details">
					{ attributes.show_label && (
						<span className="directorist-gutenberg-listing-card-element-label">Fax:</span>
					)}
