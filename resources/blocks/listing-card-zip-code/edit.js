...
import previewImg from '@image/blocks-preview/zip.webp';
...
export default function Edit( { attributes, setAttributes } ) {
	...
	return (
		<>
			...
			<div className="directorist-gutenberg-listing-card-element directorist-gutenberg-listing-card-element-zip-code">
